...
#define MEMORY_HEADER "memman.h"
#define MEMORY_START mm_start
#define MEMORY_STOP mm_shutdown
#define MEMORY_ALLOC mm_alloc
#define MEMORY_REALLOC mm_realloc
#define MEMORY_FREE mm_free
